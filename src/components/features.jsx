...
const Features = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-5 py-12 px-4 sm:px-6 lg:px-8" data-aos="fade-up">
      <h2 className="font-bold text-blue-main text-center text-4xl" data-aos="fade-down">
        Browse our set of features
      </h2>
      <p className="text-gray-600 md:max-w-[50vw] text-center" data-aos="fade-up" data-aos-delay="100">
        Jasa kami dirancang untuk memenuhi berbagai kebutuhan digital bisnis Anda, membantu Anda mencapai tujuan dan pertumbuhan yang optimal di pasar yang kompetitif.
      </p>

      <div className="flex flex-col md:flex-row justify-center mt-8 space-y-6 md:space-y-0 gap-x-10 flex-wrap" data-aos="fade-up" data-aos-delay="200">
        <div className="flex flex-col items-center justify-evenly bg-white p-6 rounded-lg border border-blue-main w-full md:w-1/4" data-aos="zoom-in">
        ...
        <div className="flex flex-col items-center bg-white p-6 rounded-lg border border-blue-main w-full md:w-1/4" data-aos="zoom-in" data-aos-delay="100">
          <div className="bg-blue-secondary p-4 rounded-full mb-4">
        ...
        <div className="flex flex-col items-center bg-white p-6 rounded-lg border border-blue-main w-full md:w-1/4" data-aos="zoom-in" data-aos-delay="200">
          <div className="bg-blue-secondary p-4 rounded-full mb-4">
